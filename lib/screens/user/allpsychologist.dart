...
class AllPsychologist extends StatefulWidget {
  var uid;
  var createdname;
  var img;
  AllPsychologist({super.key,this.createdname,this.uid});

  @override
  State<AllPsychologist> createState() => _AllPsychologistState();
}

class _AllPsychologistState extends State<AllPsychologist> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.lightBlue.shade900,
        title: Text("All Psychologists",
        style: TextStyle(
          color: Colors.white
        ),
        ),
